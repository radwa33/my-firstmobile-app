...
class Components_Screeb extends StatefulWidget {
  const Components_Screeb({Key? key}) : super(key: key);

  @override
  State<Components_Screeb> createState() => _Components_ScreebState();
}

class _Components_ScreebState extends State<Components_Screeb> {
  @override
                  ...
                  Padding(padding: EdgeInsets.all(10) ,
                    child: Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: [
                          Container(child: Image.asset('images/a2.jpg'),
                            width: 50,
                  ...
                  Padding(padding: EdgeInsets.all(10) ,
                    child: Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: [
                          Container(child: Image.asset('images/a3_.jpg'),
                            width: 50,
                  ...
                  Padding(padding: EdgeInsets.all(10) ,
                    child: Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: [
                          Container(child: Image.asset('images/a4_.jpg'),
                            width: 50,
